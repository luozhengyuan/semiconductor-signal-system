...
# 热搜热度关键词（在微博热搜 term 中做子串包含匹配）
# 板块/产品词 + 辨识度高的个股名；"深科技"等常见词组易误匹配，不收录
HEAT_KEYWORDS = [
    "存储芯片", "存储", "内存", "HBM", "DDR", "NAND", "闪存",
    "半导体", "芯片", "晶圆", "光刻", "中芯", "长鑫",
    "兆易创新", "江波龙", "佰维存储", "德明利", "香农芯创",
]
...
DEFAULT_THRESHOLDS = {
    ...
    "heat_pct_red": 90.0,     # 情绪热度同口径60日分位 >90% 🔴，>50% 🟡，其他 🟢
    "heat_pct_yellow": 50.0,
    "heat_abs_red": 250.0,    # 三源口径积累期（<10天）按绝对热度分档：≥250 爆表
    "heat_abs_yellow": 100.0, # 100~250 升温，<100 温和（雪球 TOP1=100 分/只）
}
